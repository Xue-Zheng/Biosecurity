...
#                 hashed_password = hashing.hash_value(password)
#                 cursor.execute('INSERT INTO User VALUES (NULL, %s, %s, %s, %s)', (username, hashed_password, role, lastrowid,))
#                 conn.commit()
...
#             data = {
#                 'pests': [
#                     {'images': 'Norway-rat.webp'},
#                     {'images': 'Stoat.jfif'},
#                     {'images': 'Brush-tailed Possum.jfif'},
#                 ]
#             }
...
#             elif name == 'index':
#                 cursor = conn.cursor()
#                 cursor.execute('SELECT * FROM AnimalPest limit 20')
